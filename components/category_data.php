<?php
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      if(empty($titleErr) && !empty($title) && empty($slugErr) && !empty($slug) ){
          ...
          $put_data = $bot->insertData('categories',$value);
          if($put_data !== false)

              $_SESSION['success_message'] = "Category Insert successfully.";
          else
          ...
          <div class="card-body">
            <table id="example1" class="table table-bordered table-striped">
              ...
              <?php
                ...
                $results = $bot->selectData('categories','',$conditons,'');
                          ...
                          <td>
                            <div class="btn-group">
                              ...
                              <div class="dropdown-menu" role="menu">
                                <a class="dropdown-item" href="categoryupdate.php?id=<?php echo $id; ?>">Edit</a>
                                <a class="dropdown-item" href="categorydelete.php?id=<?php echo $id; ?>" onclick="return confirm('Are you sure you want to delete this Category?');">Delete</a>
                              </div>
                            </div>
                          </td>
                      </tr>
